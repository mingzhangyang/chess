...
const en = {
  ...
  single: {
    ...
    stockfishSkill: 'Stockfish Skill',
    stockfishSkillAria: 'Stockfish skill level',
    stockfishMoveTime: 'Think Time (ms)',
    stockfishMoveTimeAria: 'Stockfish think time in milliseconds',
    stockfishExpertNote: 'Expert mode uses the Stockfish WASM engine.',
    playingAs: 'Playing as {color}',
    playingAsLabel: 'Playing as',
...
const zh = {
  ...
  single: {
    ...
    stockfishSkill: 'Stockfish 强度',
    stockfishSkillAria: 'Stockfish 强度等级',
    stockfishMoveTime: '思考时长（毫秒）',
    stockfishMoveTimeAria: 'Stockfish 思考时长（毫秒）',
    stockfishExpertNote: '专家模式使用 Stockfish WASM 引擎。',
    playingAs: '当前执子：{color}',
    playingAsLabel: '当前执子：',
    swapColors: '交换颜色',
    swap: '交换',
...
const fr = {
  ...
  single: {
    ...
    stockfishSkill: 'Niveau Stockfish',
    stockfishSkillAria: 'Niveau de force Stockfish',
    stockfishMoveTime: 'Temps de réflexion (ms)',
    stockfishMoveTimeAria: 'Temps de réflexion Stockfish en millisecondes',
    stockfishExpertNote: 'Le mode expert utilise le moteur Stockfish WASM.',
    playingAs: 'Vous jouez : {color}',
    playingAsLabel: 'Vous jouez :',
...
const es = {
  ...
  single: {
    ...
    stockfishSkill: 'Nivel de Stockfish',
    stockfishSkillAria: 'Nivel de fuerza de Stockfish',
    stockfishMoveTime: 'Tiempo de reflexión (ms)',
    stockfishMoveTimeAria: 'Tiempo de reflexión de Stockfish en milisegundos',
    stockfishExpertNote: 'El modo experto usa el motor Stockfish WASM.',
    playingAs: 'Jugando como {color}',
    playingAsLabel: 'Jugando como',
...
const ja = {
  ...
  single: {
    ...
    stockfishSkill: 'Stockfish 強さ',
    stockfishSkillAria: 'Stockfish の強さレベル',
    stockfishMoveTime: '思考時間 (ms)',
    stockfishMoveTimeAria: 'Stockfish の思考時間（ミリ秒）',
    stockfishExpertNote: 'エキスパートモードは Stockfish WASM エンジンを使用します。',
    playingAs: '{color}でプレイ中',
    playingAsLabel: 'プレイ中:',
    swapColors: '色を入れ替え',
    swap: '入れ替え',
