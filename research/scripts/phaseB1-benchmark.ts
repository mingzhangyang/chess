...
const B1_LMR_OVERRIDES: Partial<AiTuning> = {
  ...PHASE_A_OVERRIDES,
  enableLmrTable: true,
};
...
const CONFIGS = [
  ...
  { name: 'phaseA+B1', overrides: B1_LMR_OVERRIDES },
] as const;
...
const main = (): void => {
  ...
  const rows = [
    ...
    ['Samples', String(phaseA.samples), String(phaseAB1.samples), '-'],
    ['Avg ms', phaseA.avgMs.toFixed(2), phaseAB1.avgMs.toFixed(2), pct(phaseA.avgMs, phaseAB1.avgMs)],
    ['Median ms', phaseA.medianMs.toFixed(2), phaseAB1.medianMs.toFixed(2), pct(phaseA.medianMs, phaseAB1.medianMs)],
    ['Avg nodes', phaseA.avgNodes.toFixed(0), phaseAB1.avgNodes.toFixed(0), pct(phaseA.avgNodes, phaseAB1.avgNodes)],
    ['Avg qNodes', phaseA.avgQNodes.toFixed(0), phaseAB1.avgQNodes.toFixed(0), pct(phaseA.avgQNodes, phaseAB1.avgQNodes)],
    ['qNode ratio', phaseA.qNodeRatio.toFixed(4), phaseAB1.qNodeRatio.toFixed(4), pct(phaseA.qNodeRatio, phaseAB1.qNodeRatio)],
    ['Avg depth', phaseA.avgDepth.toFixed(2), phaseAB1.avgDepth.toFixed(2), pct(phaseA.avgDepth, phaseAB1.avgDepth)],
    ['Avg RFP prunes', phaseA.avgRfpPrunes.toFixed(2), phaseAB1.avgRfpPrunes.toFixed(2), pct(phaseA.avgRfpPrunes, phaseAB1.avgRfpPrunes)],
    ['Avg FP prunes', phaseA.avgFpPrunes.toFixed(2), phaseAB1.avgFpPrunes.toFixed(2), pct(phaseA.avgFpPrunes, phaseAB1.avgFpPrunes)],
    ['Avg LMP prunes', phaseA.avgLmpPrunes.toFixed(2), phaseAB1.avgLmpPrunes.toFixed(2), pct(phaseA.avgLmpPrunes, phaseAB1.avgLmpPrunes)],
  ];
  ...
  const outFile = path.join(outDir, 'phaseB1-benchmark-2026-03-03.md');
